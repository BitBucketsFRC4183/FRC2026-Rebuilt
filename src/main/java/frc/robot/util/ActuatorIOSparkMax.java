...
import frc.robot.util.ActuatorIO;
import frc.robot.util.ActuatorConstants;
...
public class ActuatorIOSparkMax implements ActuatorIO {
    ...
    public ActuatorIOSparkMax() {
        // Innit motor
        actuatorMotor = new SparkMax(ActuatorConstants.ACTUATOR_MOTOR_CAN_ID, SparkLowLevel.MotorType.kBrushless);
