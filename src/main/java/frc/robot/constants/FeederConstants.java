...
public final class FeederConstants {
  ...
  // Unit conversions
  public static final double POSITION_CONVERSION = 2.0 * Math.PI / GEAR_RATIO; // radians
  public static final double VELOCITY_CONVERSION = POSITION_CONVERSION / 60.0; // rad/sec
