...
public class DynamicPowerDistribution extends SubsystemBase {
  ...
  public void periodic(
      ShooterIOTalonFX shooter,
      HopperIOTalonFX hopper,
      IntakeIOTalonFX intake,
      ModuleIOTalonFX drive) {
    ...
    if (currentState == actionState) {
      drive.driveTalon.setVoltage(
          Math.min(drive.driveTalon.getMotorVoltage().getValueAsDouble(), voltageMax));
    }
  }
}
