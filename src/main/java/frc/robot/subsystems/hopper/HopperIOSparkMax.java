...
public class HopperIOSparkMax implements HopperIO {
  ...
  public HopperIOSparkMax() {
    ...
    outtakeLeftMotor =
        new SparkMax(
            HopperConstants.HOPPER_OUTTAKE_LEFT_MOTOR_CAN_ID, SparkLowLevel.MotorType.kBrushless);
    SparkMaxConfig leftConfig = new SparkMaxConfig();
    leftConfig
        .inverted(HopperConstants.HOPPER_OUTTAKE_LEFT_MOTOR_INVERTED)
        .idleMode(SparkMaxConfig.IdleMode.kBrake);
    outtakeLeftMotor.configure(
        leftConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);

    // Right outtake motor
    outtakeRightMotor =
        new SparkMax(HopperConstants.HOPPER_OUTTAKE_RIGHT_MOTOR_CAN_ID, MotorType.kBrushless);
    SparkMaxConfig rightConfig = new SparkMaxConfig();
    rightConfig
        .inverted(HopperConstants.HOPPER_OUTTAKE_RIGHT_MOTOR_INVERTED)
        .idleMode(SparkMaxConfig.IdleMode.kBrake);
    outtakeRightMotor.configure(
