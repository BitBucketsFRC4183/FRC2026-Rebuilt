...
public class ForearmSubsystem extends SubsystemBase {
    ...
    public void periodic() {
        ...
        if (inputs.positionDeg <= ForearmConstants.MIN_ANGLE_DEG && targetAngleDeg < inputs.positionDeg) {
            io.stop();
        }
        if (inputs.positionDeg >= ForearmConstants.MAX_ANGLE_DEG && targetAngleDeg > inputs.positionDeg) {
            io.stop();
        }
    }
    ...
    public void setAngle(double degrees) {
        targetAngleDeg = Math.max(ForearmConstants.MIN_ANGLE_DEG,
