...
/**
 * Factory class for Intake-related commands.
 * All commands assume IntakeSubsystem owns its internal state machine.
 */
public final class IntakeCommands {
    ...
    public static Command stow(IntakeSubsystem intake) {
        return Commands.runOnce(intake::stow, intake)
    ...
    public static Command deployAndIntake(IntakeSubsystem intake) {
        return Commands.sequence(
                        deploy(intake),
                        intake(intake))
                .withName("Intake.DeployAndIntake");
    }

    //Intake until Current Threshold reached
    public static Command intakeUntilCurrent(
            IntakeSubsystem intake, double currentThreshold) {
