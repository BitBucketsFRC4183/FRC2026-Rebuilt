...
public class DriveCommands {
              ...
              ChassisSpeeds speeds =
                  new ChassisSpeeds(
                      ...
                      ySpeed
                          * driveSubsystem.getMaxLinearSpeedMetersPerSec()
                          * powerSubsystem.getDriveFactor(),
                      omega * driveSubsystem.getMaxAngularSpeedRadPerSec() * 0.6);
  ...
  /**
   * Measures the velocity feedforward constants for the driveSubsystem motors.
   *
  ...
  public static Command wheelRadiusCharacterization(Drive driveSubsystem) {
    ...
    return Commands.parallel(
        // DriveSubsystem control sequence
        Commands.sequence(
